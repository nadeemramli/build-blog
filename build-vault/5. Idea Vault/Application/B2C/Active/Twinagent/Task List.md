...
- [x] Research AgentNotch architecture (open source: JSONL watching + OTLP + state machine — see [Agent Notch Reference Notes](<./Reference/Agent Notch Reference Notes.md>)).
...
Detailed milestones and acceptance criteria: [Phase 1 Breakdown](<./Phase 1 Breakdown.md>). Decisions from 2026-07-10: widget = notch pill + hotkey + tray; repo at `~/workspace/github.com/nadeemramli/twinagent`; usage = local-file providers first; VPS deferred (nothing critical there yet).
...
- [x] Research usage tracking across providers (see [Usage Tracking Research](<./Reference/Usage Tracking Research.md>)).
