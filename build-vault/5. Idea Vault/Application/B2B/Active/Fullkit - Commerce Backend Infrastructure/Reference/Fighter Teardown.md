...
> Researched 2026-07-10 from the live site, onboard flow, app/API probes. Feeds [[PRD|the Fullkit PRD]]. **EFFEN already runs one brand's orders in Fighter** — this teardown doubles as an audit map of what we're renting today.
