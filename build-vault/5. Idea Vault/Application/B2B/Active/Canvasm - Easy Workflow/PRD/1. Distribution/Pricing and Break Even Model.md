...
| --- | --- | --- | --- |
| Current lean infra | Hetzner only; Vercel, Supabase, Clerk, and Resend free | About 132 MYR/month | Cheap enough for build stage. |
...
If the first 4-5 accounts are below 99 MYR/month, keep the stack lean unless a product limit forces the upgrade.
