...
created: 2026-07-13
updated: 2026-07-13
status: active-design-superseded-by-prd
...
- [Product Requirements Document](<5. Idea Vault/2. Application/B2C/Active/AttributeOS - Local Health Evidence/PRD.md>)
- [Technical Design](<Technical Design.md>)

The PRD and Technical Design are now authoritative for product scope and implementation. This brief remains the original discovery record.

AttributeOS is the product name for a private local-first application that imports and reconciles user-owned health evidence from WHOOP, Apple Health, Hevy, MacroFactor, laboratory PDFs and other approved sources.
...
## Original admission gate

The user admitted AttributeOS to active bounded design on 2026-07-13. The following remain implementation gates:
